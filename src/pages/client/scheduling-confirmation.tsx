...
import { Calendar, CheckCircle, Clock, Copy, DollarSign, Home, MessageCircle } from "lucide-react";
...
export default function SchedulingConfirmationPage() {
  ...
  // Vindo direto da criação do agendamento, os dados já chegam prontos via
  // state — evita uma nova busca (que exigiria telefone) só para exibir a
  // confirmação de algo que acabou de ser criado nesta mesma sessão.
        ...
        <div className="py-20 container-app max-w-md mx-auto">
          <div className="text-center space-y-4">
            <p className="text-text-secondary">
              Não conseguimos exibir os detalhes deste agendamento aqui.
            </p>
            <p className="text-sm text-text-secondary">
              Isso acontece se a página foi recarregada ou aberta diretamente por este link. Use a
              consulta pública informando o código e o telefone para ver os detalhes novamente.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
              <Button onClick={() => navigate("/lookup")}>Consultar agendamento</Button>
